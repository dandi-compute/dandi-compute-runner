...
# task that is slow to start never piles up copies of itself. Each job writes its output to
# cron/logs/{task}-{job id}.log under the base directory.
set -euo pipefail
...
LOG_DIRECTORY=/orcd/data/dandi/001/dandi-compute/cron/logs
